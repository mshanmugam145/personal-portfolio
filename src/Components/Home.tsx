  ...
  return (
    <div className='mt-7 px-4 md:px-20 items-center flex flex-col md:flex-row'>
      <div>
        ...
        <span className='text-purple-600'>{AppText.shan}</span></h2>
        <h2 className='text-gray-400 mt-3'>{AppText.intro}</h2>
        <button className='bg-purple-600 p-2 mt-4 transition-all ease-in-out hover:scale-110 text-white px-3 rounded-md'>Resume</button>
      </div>
